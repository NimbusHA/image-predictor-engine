...
IMAGE_DIR = r'C:\Users\harsh\OneDrive\Desktop\Projects\image predictor\static\images'
...
def find_similar_images(img_path):
    ...
    similar_images = [os.path.join('/static/images', os.listdir(IMAGE_DIR)[i]) for i in indices[0]]
